var MapsGoogle = function () {	
    ...
    var mapMarker = function (total,jsonList) {        
    	var map = new GMaps({
            div: '#gmap_marker',
            lat:jsonList[0].latitude,
            lng:jsonList[0].longitude
        });
        
        /**for(var i=0;i<total;i++){
	        map.addMarker({
	        	lat: jsonList[i].latitude,
	    		lng: jsonList[i].longitude,                
        ...
        for(var i=0;i<total;i++){
			...
			//new StyledMarker({styleIcon:new StyledIcon(StyledIconTypes.MARKER,{color:"73B819",text:(i+1)+ "",starcolor:null,fore:'ffffff'}),position:new google.maps.LatLng(jsonList[i].latitude, jsonList[i].longitude),map:map});	
    ...
    return {
        ...
        init: function (total,jsonList) {
            //mapBasic();
          mapMarker(total,jsonList);
           // mapGeolocation();
          //  mapGeocoding();
          //  mapPolylines();
          //  mapPolygone();
