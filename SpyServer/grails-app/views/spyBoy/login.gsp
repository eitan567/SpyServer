...
<body class="login">
	...
	<div class="content">
		<!-- BEGIN LOGIN FORM -->
		<g:form class="form-vertical login-form" controller="spyBoy" action="signIn" method="post">
		...
		<form class="form-vertical forget-form" action="http://www.keenthemes.com/preview/metronic_admin_rtl/index.html" method="post">
		...
		<form class="form-vertical register-form" action="http://www.keenthemes.com/preview/metronic_admin_rtl/index.html" method="post">
			<h3 >Sign Up</h3>
			...
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-icon left">
						<i class="icon-user"></i>
						<input class="m-wrap placeholder-no-fix" type="text" placeholder="Username" autocomplete="off" name="username"/>
					</div>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-icon left">
						<i class="icon-lock"></i>
						<input class="m-wrap placeholder-no-fix" type="password" id="register_password" autocomplete="off" placeholder="Password" name="password"/>
					</div>
				</div>
			</div>
			<div class="control-group">
	...
	<script src="${resource(dir: 'uaassets/plugins/jquery-validation/dist', file: 'jquery.validate.min.js')}" type="text/javascript"></script>
	<!-- END PAGE LEVEL PLUGINS -->
	<!-- BEGIN PAGE LEVEL SCRIPTS -->
	<script src="${resource(dir: 'uaassets/scripts', file: 'app.js')}" type="text/javascript"></script>
	<script src="${resource(dir: 'uaassets/scripts', file: 'login.js')}" type="text/javascript"></script> 
