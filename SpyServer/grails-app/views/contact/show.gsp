	...
	<body>
		...
		<div id="show-contact" class="content scaffold-show" role="main">
			...
			<ol class="property-list contact">
				...
				<g:if test="${contactInstance?.number}">
				<li class="fieldcontain">
					<span id="number-label" class="property-label"><g:message code="contact.number.label" default="Number" /></span>
					
						<span class="property-value" aria-labelledby="number-label"><g:fieldValue bean="${contactInstance}" field="number"/></span>
