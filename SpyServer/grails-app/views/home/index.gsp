...
<!-- BEGIN REVOLUTION SLIDER -->    
        ...
        <div class="fullwidthabnner">
            <ul id="revolutionul" style="display:none;">            
                    ...
                    <li data-transition="fade" data-slotamount="8" data-masterspeed="700" data-delay="9400" data-thumb="assets/img/sliders/revolution/thumbs/thumb2.jpg">
                        ...
                        <a class="caption lft slide_btn btn red slide_item_left" href="../indexb80c.html?theme=metronic_admin" target="_blank" 
                             data-x="0"
                             data-y="300"
                             data-speed="400"
                             data-start="3000"
    ...
    <div class="container">
        ...
        <div class="row-fluid quote-v1">
            ...
            <div class="span3 quote-v1-inner text-left">
                <a class="btn-transparent" href="../indexb80c.html?theme=metronic_admin" target="_blank"><i class="icon-rocket margin-left-10"></i>Preview Admin</a>
        ...
        <div class="row-fluid recent-work margin-bottom-40">
            ...
            <div class="span9 bxslider-container">
                <ul class="bxslider">
                    <li>
                        <em>
                ...
                <div class="tab-content">
                    <div class="tab-pane row-fluid fade in active" id="tab-1">
                        ...
                        <div class="span9">
                            ...
                            <p><a class="more" href="#">Read more <i class="icon-angle-left"></i></a></p>
                        </div>
                    </div>
                    ...
                    <div class="carousel-inner">
                        <div class="active item">
                            ...
                            <div class="carousel-info">
                                <img class="pull-right" src="assets/img/people/img1-small.jpg" alt="" />
                        ...
                        <div class="item">
                            ...
                            <div class="carousel-info">
                                <img class="pull-right" src="assets/img/people/img5-small.jpg" alt="" />
                                <div class="pull-right">
                        ...
                        <div class="item">
                            ...
                            <div class="carousel-info">
                                <img class="pull-right" src="assets/img/people/img2-small.jpg" alt="" />
                                <div class="pull-right">
